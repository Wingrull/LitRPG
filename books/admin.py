...
class SeriesAdmin(admin.ModelAdmin):
    ...
    def cover_preview(self, obj):
        if obj.cover_image:
            ...
            return format_html('<img src="data:{};base64,{}" width="100" height="auto" />', obj.cover_content_type, base64_data)
        return "Нет обложки"
...
class BookAdmin(admin.ModelAdmin):
    ...
    def cover_preview(self, obj):
        if obj.cover_image:
            base64_data = base64.b64encode(obj.cover_image).decode('utf-8')
            return format_html('<img src="data:{};base64,{}" width="80" height="auto" />', obj.cover_content_type, base64_data)
        return "Нет обложки"
    cover_preview.short_description = "Предпросмотр обложки"
